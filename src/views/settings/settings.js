        ...
        <div class="flex-container col-100 hc no-touch-top">
            ...
            <div class="panel col-50 no-touch-top" style="vertical-align: top;">
                ...
                <div class="panel-content">
                    ...
                    <div class="input-group vhc">
                        <div style="font-size:13px;" class="checkbox-label">Hidden</div>
                        <label class="switch" for="ap-hidden-checkbox">
                            <input type="checkbox" id="ap-hidden-checkbox" v-model="accesspoint.hidden"/>
            ...
            <div class="panel col-50 no-touch-top " style="vertical-align: top;">
                ...
                <div class="panel-content">
                    ...
                    <div class="input-group vhc">
                        <div style="font-size:13px;" class="checkbox-label">Deep</div>
                        <label class="switch" for="aps-deep-checkbox">
                            <input type="checkbox" id="aps-deep-checkbox" v-model="apScanner.deep"/>
                            <div class="slider round"></div>
                        </label>
                    </div>
                    <div class="input-group vhc">
                        <div style="font-size:13px;" class="checkbox-label">Async</div>
                        <label class="switch" for="aps-async-checkbox">
                            <input type="checkbox" id="aps-async-checkbox" v-model="apScanner.async"/>
                            <div class="slider round"></div>
                        </label>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group vhc">
                        <div style="font-size:13px;" class="checkbox-label">Hop</div>
                        <label class="switch" for="aps-hop-checkbox">
                            <input type="checkbox" id="aps-hop-checkbox" v-model="apScanner.hop"/>
                            <div class="slider round"></div>
                        </label>
                    </div>
                </div>
            ...
            <div class="panel col-50 no-touch-top" style="vertical-align: top;">
                ...
                <div class="panel-content">
                    ...
                    <div class="input-group vhc">
                        <div style="font-size:13px;" class="checkbox-label">Hop</div>
                        <label class="switch" for="ps-hop-checkbox">
                            <input type="checkbox" id="ps-hop-checkbox" v-model="packetScanner.hop"/>
                            <div class="slider round"></div>
                        </label>
                    </div>
                </div>
